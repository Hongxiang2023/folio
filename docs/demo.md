...
Use the [live walkthrough](https://hongxiang2023.github.io/refhaven/demo/), or download the project and open [`demo/index.html`](demo/index.html) in your browser. GitHub shows HTML source rather than executing it, so open the downloaded file locally. It is self-contained and works without a server, build, network request, or account.
